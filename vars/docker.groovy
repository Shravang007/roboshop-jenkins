def call() {
    node('workstation') {
        ...
        stage('Publish an Artifact') {
                sh 'docker tag ${component} 752442278108.dkr.ecr.us-east-1.amazonaws.com/${component}:latest'
                ...
                sh 'docker push 752442278108.dkr.ecr.us-east-1.amazonaws.com/${component}:latest'
